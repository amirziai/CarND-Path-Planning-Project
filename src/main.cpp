        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            for (int i = 0; i < sensor_fusion.size(); i++) {
                ...
                int safety_margin = 25;

                if (car_lane == lane) car_ahead |= check_car_s > car_s && check_car_s - car_s < safety_margin;
                else if (car_lane - lane == -1) car_left |= car_s - safety_margin < check_car_s && car_s + safety_margin > check_car_s;
                else if (car_lane - lane == 1) car_right |= car_s - safety_margin < check_car_s && car_s + safety_margin > check_car_s;
            }
            ...
            if (car_ahead) {
                ...
                if (lane != 1) if ((lane == 0 && !car_right) || (lane == 2 && !car_left)) lane = 1;
                if (ref_velocity < MAX_SPEED) speed_diff += MAX_ACC;
            }
